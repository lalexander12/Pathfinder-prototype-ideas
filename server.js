...
// nunjucksAppEnv.addFilter('pluralise', (word, number) => (number === 1 ? word : `${word}s`))
// nunjucksAppEnv.addFilter('findErrorMap', (errorKeys, formFieldId) => {
//   if (errorKeys) {
//     const item = errorKeys.find(error => errorKeys.includes(`#${formFieldId}`))
//     if (item) {
//       return {
//         text: item.text,
//       }
